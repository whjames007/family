    ...
    <el-container>
      <el-header>
        <el-row>
          ...
          <el-col :span="8"><div class="local-home-center">正维电子货架商品监控系统</div></el-col>
          <el-col :span="8"><div class="local-home-right"><i class="el-icon-user-solid"></i>{{user.systemUserNickname}}&nbsp;[{{user.systemRoleName}}]<el-popconfirm title="您好，您确定要退出本系统吗？" @confirm="logoutMethodConfirm"><el-button slot="reference" type="primary" icon="el-icon-s-promotion" class="wuhan-color-danger">退出</el-button></el-popconfirm></div></el-col>
        </el-row>
      </el-header>
      <el-main>
        <el-row>
      ...
      <el-footer class="local-home-center">武汉正维电子技术有限公司</el-footer>
    </el-container>
  </div>
</template>
